...
```
Se observa que existen 83 localizaciones diferentes. Esta información se puede utilizar para crear un mapa en el que podamos visualizar la distribución de los acuerdos.
Cabe destacar que se han identificado 35 valores nulos en el atributo que deben ser tratados.
...
write.xlsx(salida, "../data/pax_all_agreements_data_proc.xlsx")
